...
summary: '最近在整理公司的数据分析流程，发现一个老问题又冒出来了：UTM 参数乱打。 打开 Google Analytics 一看，utmsource 里同时存在 Facebook、facebook、fb、FB 四种写法，本来应该是同一个来源的数据，硬生生被拆成了四行。更离谱的是 utmcampaign 里有人写中文、有人写拼音、有人写英文，根本没法做归类分析。 所以决定整理一份 UTM 规范，方便团队统一'
slug: 'utm-tracking-gui-fan-zheng-licong-gai-nian-dao-ming-ming-gui'
tags:
  - utm
  - analytics
  - seo
