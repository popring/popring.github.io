---
title: 'JavaScript 继承有哪几种实现方式？｜前端面试题（十）'
publishedAt: '2020-08-02'
summary: '前端面试题第十篇：JavaScript 六种继承写法逐一对比优缺点，另覆盖 HTTP 报文与 get/post 区别、XSS/CSRF、浏览器渲染重排重绘及前端错误监控上报。'
tags:
  - 面试题
  - javascript
  - 性能优化
...
**系列导航**：[上一篇：前端面试题（九）](/blog/frontend-interview-daily-9) · [下一篇：前端面试题（十一）](/blog/frontend-interview-daily-11)
