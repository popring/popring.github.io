...
summary: 'Mini Program Notes 尺寸单位 - rpx和px rpx（responsive pixel）: 可以根据屏幕宽度进行自适应。规定屏幕宽为750rpx。如在 iPhone6 上，屏幕宽度为375px，共有750个物理像素，则750rpx = 375px = 750物理像素，1rpx = 0.5px = 1物理像素。 | 设备 | rpx换算px (屏幕宽度/750) | px换算rp'
slug: 'wei-xin-xiao-cheng-xu-kai-fa-cai-keng-zhi-nan'
tags:
  - 小程序
  - wepy
  - 踩坑记录
