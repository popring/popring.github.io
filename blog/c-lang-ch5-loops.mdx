...
summary: 'C 语言第五章循环结构笔记：while、do-while、for 三种循环的执行顺序与区别，break/continue 的用法，并以素数判断为例演示穷举法。'
tags:
  - c语言
  - 学习笔记
category: '编程语言'
...
**系列导航**：[上一篇：第四章 选择结构](/blog/c-lang-ch4-selection) · [下一篇：第六章 数组](/blog/c-lang-ch6-arrays)
