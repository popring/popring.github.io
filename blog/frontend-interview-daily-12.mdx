---
title: 'Vue 双向数据绑定是什么原理？｜前端面试题（十二）'
publishedAt: '2021-02-20'
summary: '前端面试题第十二篇：RESTful API 设计要点（HTTP 动词、版本号、资源命名），Vue 基于 Object.defineProperty 的双向绑定原理，以及 margin/padding 百分比的基准。'
tags:
  - 面试题
  - http
  - vue
...
**系列导航**：[上一篇：前端面试题（十一）](/blog/frontend-interview-daily-11)
