---
title: 'z-index 层叠顺序是怎么计算的？｜前端面试题（四）'
publishedAt: '2020-06-28'
summary: '前端面试题第四篇：CSS 放头部 script 放底部的原因、@import 与 link 的区别、z-index 层叠顺序经典题解析、flex-shrink 缩放计算，以及连续赋值与 let/var 输出题。'
tags:
  - 面试题
  - javascript
  - css
...
**系列导航**：[上一篇：前端面试题（三）](/blog/frontend-interview-daily-3) · [下一篇：前端面试题（五）](/blog/frontend-interview-daily-5)
