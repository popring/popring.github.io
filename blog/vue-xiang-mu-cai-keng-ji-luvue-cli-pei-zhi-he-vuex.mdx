...
summary: '去哪儿网项目链接 Vue-cli 配置 Vue-cli 2.x 和 Vue-cli 3.x 配置webpack别名目录 alias vue-cli 2.x vue-cli 3.x 直接在项目根目录新建 vue.config.js'
slug: 'vue-xiang-mu-cai-keng-ji-luvue-cli-pei-zhi-he-vuex'
tags:
  - vue
  - 踩坑记录
category: '前端'
