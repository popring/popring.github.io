---
title: '用 AI 配置路由器自动翻墙：红米 AX6000 科学上网（ShellCrash 全程代劳）'
publishedAt: '2026-07-05'
summary: '不用刷 OpenWrt——解锁红米 AX6000 的 SSH、装上 ShellCrash，整台路由器就能自动分流科学上网：海外走节点、国内直连，全屋设备一次搞定。而且这次从解锁到配代理我没自己敲命令，是把完整上下文喂给 AI 让它全程做的，文末附可复制 skill。'
tags:
  - 科学上网
  - 翻墙
  - 路由器
...
- **想自定义程度更高：刷 [OpenWrt](https://openwrt.org/)。** 配合 [OpenClash](https://github.com/vernesong/OpenClash) 等插件、LuCI 图形界面，防火墙、DNS、分流规则全都能自己捏，玩法多得多。代价是要刷 U-Boot、动 factory / bdata 分区，变砖风险高、也更折腾——适合确实有定制需求、愿意花时间的人。
