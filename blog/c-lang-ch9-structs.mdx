...
summary: 'C 语言第九章结构体笔记：结构体的定义、初始化与嵌套，结构体指针的 -> 用法，typedef 起别名，malloc/free 内存管理与单向链表的创建插入删除。'
tags:
  - c语言
  - 学习笔记
category: '编程语言'
...
**系列导航**：[上一篇：第八章 指针（下）](/blog/c-lang-ch8-pointers-2) · [下一篇：第十章 文件操作](/blog/c-lang-ch10-file-io)
