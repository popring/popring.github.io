---
title: 'HTTP 304 是什么？协商缓存是怎么工作的？｜前端面试题（五）'
publishedAt: '2020-06-29'
summary: '前端面试题第五篇：结合 ETag/If-None-Match 抓包演示 304 状态码原理，并梳理 HTTP 0.9 到 2.0 的版本演进：持久连接、管道机制、多路复用与头信息压缩。'
tags:
  - 面试题
  - http
category: '面试'
...
**系列导航**：[上一篇：前端面试题（四）](/blog/frontend-interview-daily-4) · [下一篇：前端面试题（六）](/blog/frontend-interview-daily-6)
