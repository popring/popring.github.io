---
title: '跨域有哪几种解决方案？｜前端面试题（二）'
publishedAt: '2020-06-25'
summary: '前端面试题第二篇：content-box 与 border-box 盒模型、常见 CSS 布局方式、JSONP 与 CORS 跨域方案、XSS/CSRF 防御，以及防抖和节流的手写实现。'
tags:
  - 面试题
  - javascript
  - css
...
**系列导航**：[上一篇：前端面试题（一）](/blog/frontend-interview-daily-1) · [下一篇：前端面试题（三）](/blog/frontend-interview-daily-3)
