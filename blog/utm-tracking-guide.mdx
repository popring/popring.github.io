...
summary: 'UTM 追踪规范整理：五个核心参数的含义、命名规则与团队词汇表，配邮件、广告投放、KOL 推广等真实场景示例，并记录站内链接加 UTM 导致来源失真等踩坑教训。'
tags:
  - utm
  - analytics
  - seo
...
希望这篇整理对你有帮助。UTM 只是获客链路里的一小环，它在增长工作全景里的位置，我后来在[《AARRR 五个阵地：增长工程师到底做什么》](/blog/growth-engineering-battlefields)里单独写过。
