...
summary: '更多面经请移步：https://www.nowcoder.com/profile/464647589/myDiscussPost 个人校招面经 有些可能写的不全，没有及时总结（这是个坏习惯），有的只是总结了下个人回答的不太好的部分，仅供参考。'
slug: '2020-qiu-zhao-shi-xi-qian-duan-mian-jing'
tags:
  - 面试题
  - 面经
category: '面试'
