---
title: 'SEO 入门学习笔记：ahrefs 系列要点整理'
publishedAt: '2025-05-27'
summary: 'SEO 入门学习笔记：总结 ahrefs 系列文章的技术 SEO（抓取索引、关键词研究、页面与元标签优化）与 UX 侧的 CTR、跳出率、参与度三大行为信号，并整理 GSC、Ahrefs 等常用工具。'
tags:
  - seo
  - 学习笔记
category: '前端'
...
SEO 做的是获客，而获客只是增长的第一个阵地——它和激活、留存怎么串成一条完整的链路，我在[《AARRR 五个阵地：增长工程师到底做什么》](/blog/growth-engineering-battlefields)里写过。
