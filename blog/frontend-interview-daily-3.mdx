---
title: 'JavaScript 闭包是什么？有什么实际用途？｜前端面试题（三）'
publishedAt: '2020-06-26'
summary: '前端面试题第三篇：三种垂直水平居中写法、闭包经典循环问题与解法、强缓存与协商缓存机制（Expires/Cache-Control/ETag），以及前端性能优化清单。'
tags:
  - 面试题
  - javascript
  - http
...
**系列导航**：[上一篇：前端面试题（二）](/blog/frontend-interview-daily-2) · [下一篇：前端面试题（四）](/blog/frontend-interview-daily-4)
