---
title: 'React setState 是同步还是异步？｜前端面试题（六）'
publishedAt: '2020-06-30'
summary: '前端面试题第六篇：通过三道编程题拆解 React setState 在合成事件与 setTimeout 中的“异步”差异、Hooks 闭包陷阱，以及 useEffect 清除函数的执行时机。'
tags:
  - 面试题
  - react
category: '面试'
...
**系列导航**：[上一篇：前端面试题（五）](/blog/frontend-interview-daily-5) · [下一篇：前端面试题（七）](/blog/frontend-interview-daily-7)
