---
title: 'JavaScript 原型链是怎么工作的？｜前端面试题（九）'
publishedAt: '2020-08-01'
summary: '前端面试题第九篇：标准与 IE 盒模型及 JS 获取宽高的四种方式、DOM 事件级别与捕获冒泡流程、原型链关系图解、instanceof 原理与手写 new 实现。'
tags:
  - 面试题
  - css
  - javascript
...
**系列导航**：[上一篇：前端面试题（八）](/blog/frontend-interview-daily-8) · [下一篇：前端面试题（十）](/blog/frontend-interview-daily-10)
