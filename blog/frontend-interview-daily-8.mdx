---
title: 'display:none 和 visibility:hidden 有什么区别？｜前端面试题（八）'
publishedAt: '2020-07-30'
summary: '前端面试题第八篇：display:none 与 visibility:hidden 的三点区别——是否占据布局位置、属性继承行为差异、修改后是否触发重新渲染，配代码对比演示。'
tags:
  - css
  - 面试题
category: '面试'
...
**系列导航**：[上一篇：前端面试题（七）](/blog/frontend-interview-daily-7) · [下一篇：前端面试题（九）](/blog/frontend-interview-daily-9)
