---
title: 'Promise、Generator、async/await 有什么区别？｜前端面试题（十一）'
publishedAt: '2020-08-08'
summary: '前端面试题第十一篇：从回调、Promise 到 async/await 的异步编程演进，load 与 DOMContentLoaded 触发时机，箭头函数特性及 for...of 和 for...in 的区别。'
tags:
  - 面试题
  - javascript
category: '面试'
...
**系列导航**：[上一篇：前端面试题（十）](/blog/frontend-interview-daily-10) · [下一篇：前端面试题（十二）](/blog/frontend-interview-daily-12)
