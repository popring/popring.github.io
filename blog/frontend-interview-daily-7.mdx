---
title: '三栏自适应布局有哪几种实现？｜前端面试题（七）'
publishedAt: '2020-07-27'
summary: '前端面试题第七篇：两种遍历统计文档内所有 DOM 标签的写法，以及三栏自适应布局的五种实现：float、绝对定位、flex、table 与 grid，附完整可运行代码。'
tags:
  - 面试题
  - css
category: '面试'
...
**系列导航**：[上一篇：前端面试题（六）](/blog/frontend-interview-daily-6) · [下一篇：前端面试题（八）](/blog/frontend-interview-daily-8)
