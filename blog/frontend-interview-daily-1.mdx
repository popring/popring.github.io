---
title: 'call、apply、bind 有什么区别？｜前端面试题（一）'
publishedAt: '2020-06-24'
summary: '前端面试题第一篇：BFC 的创建条件与 margin 重叠、首页白屏优化、函数柯里化实现、bind/apply/call 区别，以及浏览器与 Node 事件循环机制的差异。'
tags:
  - 面试题
  - javascript
  - css
...
**系列导航**：[下一篇：前端面试题（二）](/blog/frontend-interview-daily-2)
